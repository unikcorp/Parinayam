...
export default function HighlightPackagesPage() {
  ...
  const showUpgradeNotice = !membershipLoading && !isPremium;

  return (
    <>
      {/* Mobile-only back header — desktop uses the persistent AppHeader nav */}
      <MobileBackHeader title="Profile Highlight" href="/settings/profile-highlight" />
