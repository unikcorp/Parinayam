...
import { StickyActionBar } from "@/components/parinayam/sticky-action-bar";
import { Reveal } from "@/components/parinayam/reveal";
import { AnimatedStat } from "@/components/parinayam/animated-stat";
...
const profiles = [
  { name: "Anjali M", age: 27, job: "Software Engineer, Infopark", place: "Kochi, Ernakulam", match: 92, premium: true, online: true },
  { name: "Arjun N", age: 29, job: "Chartered Accountant", place: "Thrissur", match: 88, premium: false, online: false },
  { name: "Devika K", age: 26, job: "Dentist, Govt. Service", place: "Kozhikode", match: 90, premium: true, online: false },
  { name: "Vishnu P", age: 30, job: "Bank Manager, SBI", place: "Thiruvananthapuram", match: 85, premium: false, online: true },
];
...
const testimonials = [
  { initials: "RN", name: "Radhika Nair", meta: "Mother of member · Kottayam", quote: "As a parent, I could manage my daughter’s profile respectfully. The verification gave us real peace of mind." },
  { initials: "SM", name: "Sreejith Menon", meta: "Premium member · Kochi", quote: "Clean, fast and no fake profiles. Compared to the older sites, this feels like a different generation." },
  { initials: "PV", name: "Parvathy V", meta: "Member · Kannur", quote: "The AI match score was surprisingly accurate. My now-fiancée was my very first suggested match." },
];
      ...
      <section id="stories" className="bg-surface-cream py-9 pl-5 lg:px-18 lg:py-20">
        ...
        <div className="hidden lg:grid lg:grid-cols-3 lg:gap-7">
          <Reveal className="lg:col-span-2">
            <StoryCard story={stories[0]} imgClassName="h-72" />
          </Reveal>
